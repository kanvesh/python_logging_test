...
* The above works for an API-like module which is called from other extension applications. My use case is mainly to do with an _Application-level_ logger that also works with smaller modules that are called along the way, with least intervention.
